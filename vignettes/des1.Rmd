...
Given a set of $\{a_{1},a_{2},...,a_{n}\}$ arrival times and $\{s_{1},s_{2},...,s_{n}\}$ service times, the delays $\{d_{1},d_{2},...,d_{n}\}$ can be computed. The algorithm `des1_2_1` assumes a single-server FIFO system with infinite capacity.
